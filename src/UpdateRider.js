 ...
 return(
    ...
    <section className="content">
      <div className="row">
        <div className="col-md-10">
          <div className="card card-primary">
            <div className="card-header" style = {{background: ' #28a745'}} >
              <h3 className="card-title" > Update Rider Status</h3>
        ...
        <Link to = "/viewriders"> <button type="submit" className="btn btn-success float-right" onClick= {this.handleSubmit} >Update Status</button></Link>
        </div>
