 ...
 getItems = async () =>
    {
      ...
      try{
  let turl = 'http://www.cinemahd-apk.com:3005/findalljobs';
  if(localStorage.getItem('admin')!='true')
  {
    turl =
      "http://www.cinemahd-apk.com:3005/findmyjobs/"+localStorage.getItem('_id');
  ...
  else
  {
     ...
     turl = 'http://www.cinemahd-apk.com:3005/findalljobs';
...
const url = "http://www.cinemahd-apk.com:3005/removejob/";
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
             ...
             {localStorage.getItem("admin") === "true" ? (
              <h3 class="card-title"> 
               ...
               {/* <button type = "submit"   value= "res"  onClick={this.statusHandler.bind(this)}    class = "btn btn-success"  style= {{float:'right', marginLeft:2}} ><i class="fas fa-building"></i>Resturant</button> */}
                {/* <button type = "submit"    value= "str"  onClick={this.statusHandler.bind(this)}   class = "btn btn-success" style= {{float:'right', marginLeft:2}} ><i class="fas fa-store"></i>Vendor</button>  </h3> */}
            ...
            <tr className="trow" key = {item._id} orderidv = {item._id}>
             {/* <td  >{item._id }</td> */}
       ...
       {/* {item.assigned_to !== "0" ? (
         ...
         <td > {item.assigned_to} 
          ...
          <button  style= {{float:'right', marginLeft:2}}  class="btn btn-info btn-sm" onClick ={this.rydershow.bind(this , item.assigned_to)} >
...
{/*                        
                      ...
                      {/* <button type="submit" class="btn btn-block btn-outline-success btn-sm" onClick={this.editOrder.bind(this, item._id, item.status)} >{item.status}</button> */}
