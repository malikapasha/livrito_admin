 ...
 getItems = async () =>
    {
      ...
      try{
  let turl = 'https://livrito.herokuapp.com/findalljobs';
  if(localStorage.getItem('admin')!='true')
  {
    turl =
      "https://livrito.herokuapp.com/findmyjobs/"+localStorage.getItem('_id');
  ...
  else
  {
     ...
     turl = 'https://livrito.herokuapp.com/findalljobs';
...
const url = "https://livrito.herokuapp.com/removejob/";
