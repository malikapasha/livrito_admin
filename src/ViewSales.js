    ...
    <section class="content">
      ...
      <select value ={ this.state.editData.status} onChange = {(e) =>{
        ...
        <td > <button class="btn btn-block btn-outline-success btn-sm" >{item.status} </button></td> 
                    ...
                    <td style = {{display:'flex'}}> <button  type = "submit" class="btn btn-info btn-sm"  onClick ={this.editOrder.bind(this , item._id , item.status ,item.name ,item.email, item.password, item.contact , item.gender )}  >
