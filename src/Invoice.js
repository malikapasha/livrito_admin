            ...
            <div className="invoice p-3 mb-3">
              ...
              <div className="row invoice-info">
                ...
                <div className="col-sm-4 invoice-col">
                 User Information
                  <address>
                    <strong> Name: </strong>
                     <strong> {localStorage.getItem('orname')}</strong>
                    ...
                    <strong>Address: </strong>
                        <strong> {localStorage.getItem('oraddress')}</strong>
                    <br/>
                     <strong>Contact: </strong>
                        <strong> {localStorage.getItem('orcell')}</strong>
                     <br/>
              ...
              <div className="row">
                ...
                this.state.Items.map((item , i) =>
                    ...
                    {localStorage.getItem("order_type") == "res" ? (
                      <td> {item.quantity} </td>
                    ...
                    {localStorage.getItem("order_type") === "res" ? (
                      ...
                      <td> {item.pr_quantity* item.price} </td>
                    }
